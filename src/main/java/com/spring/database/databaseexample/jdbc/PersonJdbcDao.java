package com.spring.database.databaseexample.jdbc;
...
public class PersonJdbcDao {
    ...
    class PersonRowMapper implements RowMapper<Person> { // Custom Spring JDBC Row Mapper
    ...
    public int deleteByNameAndLocation(String  name, String location) {
        return jdbcTemplate.update(
                "delete from person where name =? and location=?", new Object[] {name, location});
    }

    public int deleteByNameOrLocation(String  name, String location) {
        return jdbcTemplate.update(
                "delete from person where name =? or location=?", new Object[] {name, location});
    }
